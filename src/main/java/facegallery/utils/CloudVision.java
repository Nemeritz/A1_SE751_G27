...
public class CloudVision {
     ...
     *
     * @param gcsPath The path to the remote file on Google Cloud Storage to perform
     *                face detection on.
     * @param out     A {@link PrintStream} to write detected features to.
     * @throws Exception   on errors while closing the client.
     * @throws IOException on Input/Output errors.
    ...
    /**
     * Detects whether the specified image on Google Cloud Storage has features you
     * would want to moderate.
     *
     * @param gcsPath The path to the remote file on Google Cloud Storage to detect
     *                safe-search on.
     * @param out     A {@link PrintStream} to write the results to.
    ...
    /**
     * Detects whether the remote image on Google Cloud Storage has features you
     * would want to moderate.
     *
     * @param gcsPath The path to the remote on Google Cloud Storage file to detect
     *                web annotations.
     * @param out     A {@link PrintStream} to write the results to.
     * @throws Exception   on errors while closing the client.
     * @throws IOException on Input/Output errors.
    ...
    public static void detectWebEntitiesIncludeGeoResults(String filePath, PrintStream out)
        ...
        try (ImageAnnotatorClient client = ImageAnnotatorClient.create()) {
            ...
            // Create the request with the image, imageContext, and the specified feature:
            // web detection
            AnnotateImageRequest request = AnnotateImageRequest.newBuilder()
                    .addFeatures(Feature.newBuilder().setType(Type.WEB_DETECTION)).setImage(image)
